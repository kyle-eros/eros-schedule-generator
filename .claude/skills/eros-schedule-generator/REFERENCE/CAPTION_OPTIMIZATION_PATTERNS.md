# Caption Optimization Patterns

> Detailed algorithms and examples extracted from caption-optimizer agent.
> Version: 3.0.0 | Date: 2025-12-20

## Table of Contents
- [Scoring Algorithms](#scoring-algorithms)
- [Optimization Algorithm](#optimization-algorithm)
- [A/B Variant Generation](#ab-variant-generation)
...
*See also: [caption-optimizer agent](../../../agents/caption-optimizer.md)*
